...
class adjmatrix extends JFrame
{
/**
	 * 
	 */
...
ImageIcon image;
	...
	setTitle("	FACEBOOK ADJENCY MATRIX OUTPUT");
...
b1.addActionListener(new ActionListener()
{
  ...
  {JOptionPane.showMessageDialog (null, "Adjency Matrix  has been Generated", "Adjency matrix ", JOptionPane.INFORMATION_MESSAGE);
